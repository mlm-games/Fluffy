...
import app.fluffy.data.local.AppDao
import app.fluffy.data.model.FDroidApp
...
class RepositorySyncManager(
    private val api: app.fluffy.data.remote.FDroidApi,
            ...
            repos.forEachIndexed { index, repo ->
                ...
                try {
                    ...
                    val headers = api.fetchWithCache(
                        repo = repo,
                        previous = app.fluffy.data.remote.FDroidApi.RepoHeaders(prevHeader.etag, prevHeader.lastModified),
                        force = force
                    ) { app ->
